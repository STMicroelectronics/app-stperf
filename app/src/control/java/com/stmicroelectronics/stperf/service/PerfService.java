...
public class PerfService extends Service implements CustomButton.OnClickListener {
    ...
    private boolean mCpuFreqSwitch;
    ...
    public void onCreate() {
        ...
        mCpuFreqSwitch = preferences.getBoolean(getString(R.string.pref_cpu_freq_switch_label),true);

        mPeriod = Long.parseLong(preferences.getString(getString(R.string.pref_period_label), DEFAULT_PERIOD));

        mLayout = new PerfLayout(getApplicationContext(), mGraph, mPos, mCpuFreqSwitch, this);
    ...
    @Override
    public void onClick() {
        mPerformance.setNextCpuFrequency();
    }
}
